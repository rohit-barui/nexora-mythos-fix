...
class AgentServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.Register = channel.unary_unary(
            "/nexora.agent.v2.AgentService/Register",
        ...
        self.Heartbeat = channel.unary_unary(
            "/nexora.agent.v2.AgentService/Heartbeat",
        ...
        self.Execute = channel.unary_unary(
            "/nexora.agent.v2.AgentService/Execute",
        ...
        self.GetStatus = channel.unary_unary(
            "/nexora.agent.v2.AgentService/GetStatus",
            request_serializer=agent__pb2.GetStatusRequest.SerializeToString,
            response_deserializer=agent__pb2.GetStatusResponse.FromString,
            _registered_method=True,
        )
...
def add_AgentServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        "GetStatus": grpc.unary_unary_rpc_method_handler(
            servicer.GetStatus,
            request_deserializer=agent__pb2.GetStatusRequest.FromString,
            response_serializer=agent__pb2.GetStatusResponse.SerializeToString,
        ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
        "nexora.agent.v2.AgentService", rpc_method_handlers
    )
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers("nexora.agent.v2.AgentService", rpc_method_handlers)
...
class AgentService:
    ...
    def GetStatus(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/nexora.agent.v2.AgentService/GetStatus",
            agent__pb2.GetStatusRequest.SerializeToString,
            agent__pb2.GetStatusResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
